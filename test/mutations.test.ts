...
describe('mutations', () => {
    describe('addScores', () => {
        it('should return score when no score exists', () => {
            ...
            expect(state.scores).toStrictEqual({Danni: {rounds: [1], total: 1}, Matt: {rounds: [2], total: 2}})
        ...
        it('should return score when scores exists', () => {
            ...
            addScores(state, playerScores)
            expect(state.scores).toStrictEqual({Danni: {rounds: [2], total: 2}, Matt: {rounds: [1, 2], total: 3}, Bob: {rounds: [1], total: 1}})
